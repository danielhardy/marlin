...
import { Agent } from "https://esm.sh/github:danielhardy/obru-ai@main";
import type { Tool as ObruTool } from "https://esm.sh/github:danielhardy/obru-ai@main"; // Assuming type export
